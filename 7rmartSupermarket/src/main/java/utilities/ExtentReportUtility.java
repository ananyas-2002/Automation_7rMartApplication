...
public class ExtentReportUtility {
	...
	public synchronized static ExtentReports createExtentReports() { // mult testcases shuld not collide so
		...
		reporter.config().setReportName("7rmartsupermarket"); // config().setReportName("7RMart Project") 2 methods in
																// ExtentSparkReporter
		...
		extentReports.setSystemInfo("Name", "Ananya");// team membersname
