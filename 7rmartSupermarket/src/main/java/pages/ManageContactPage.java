...
public class ManageContactPage {
	...
	WebElement manangecontact;
	// @FindBy(xpath="(//a[@class='small-box-footer'])[3]")WebElement
	// managecontactmoreinfo;
	...
	@FindBy(xpath = "//button[contains(@class,'info')]")
	WebElement updatemanagecontactbutton;
	@FindBy(xpath = "//div[contains(@class,'dismissible')]")
	WebElement contactupdatedalert;
	...
	/*
	 * public ManageContactPage clickManageContact() { manangecontact.click();
	 * return this; } public void clickManageContactMoreInfo() {
